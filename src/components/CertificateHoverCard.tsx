...
export function CertificateHoverCard({certificate}: CertificateHoverCardProps) {
  return(
    ...
    <HoverCard>
      <HoverCardTrigger href={certificate.link}	aria-label={certificate.title} target="_blank" className=" hidden lg:block cursor-pointer p-4 rounded-full shadow-inner shadow-slate-600 hover:scale-105 duration-500 hover:saturate-50">
        <FaGraduationCap />
      </HoverCardTrigger>
